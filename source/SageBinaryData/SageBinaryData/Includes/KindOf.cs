...
public enum KindOf
{
    ...
    TURRET_CREATED_FROM_UNIT,
    SCORE,
    TREAT_AS_TERRAIN_FOR_LINE_OF_SIGHT,
    SCORE_DESTROY,
    NO_HEAL_ICON,
    CAN_RAPPEL,
    PARACHUTABLE,
    ...
    FLINGABLE_PROP,
    PRODUCED_FROM_ABOVE,
    PATH_THROUGH_ENEMY_VEHICLES,
    REBUILD_HOLE,
    DETECTOR,
    ATTACKS_BRIDGE_GATEHOUSE,
    INVALID_TARGET_FOR_C4
}

[StructLayout(LayoutKind.Sequential)]
public struct KindOfBitFlags
{
    public const int Count = 291;
