...
public struct ArmorTemplate
{
    ...
    /// <summary>
    /// If a unit takes damage from the side this scalar is applied to the incoming damage in addition to the regular DamageScalar
    /// </summary>
    public Percentage SideDamageScalar;
    /// <summary>
    /// If a unit takes damage from the rear this scalar is applied to the incoming damage in addition to the regular DamageScalar
    /// </summary>
