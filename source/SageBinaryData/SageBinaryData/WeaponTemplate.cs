...
#if KANESWRATH
[StructLayout(LayoutKind.Sequential)]
public struct MetaGameOperationNuggetType
{
    public DamageNuggetType Base;
    public MetagameOperationsEnums OperationToFire;
    public AssetReference<SpecialPowerTemplate> SpecialPowerTemplate;
}

[StructLayout(LayoutKind.Sequential)]
public struct DOTNuggetType
{
    public DamageNuggetType Base;
    public uint DamageInterval;
    public uint DamageDuration;
    /// <summary>
    /// Does DamageDecay less each pulse
    /// </summary>
    public float DamageDecay;
    public ObjectStatusBitFlags AppliedStatus;
    /// <summary>
    /// Treats the first two values as metagame turns instead of seconds
    /// </summary>
    public SageBool UseMetaGameTurns;
}
#endif
...
#if KANESWRATH
[StructLayout(LayoutKind.Sequential)]
public struct CrushTiberiumNuggetType
{
    public WeaponEffectNugget Base;
    public DamageFXType DamageFXType;
    public float Radius;
    public Angle DamageArc;
    public Percentage ProductionModifer;
}
#endif
...
public struct WeaponTemplate
{
    ...
    /// <summary>
    /// Played when a single bullet/missile/etc is loaded. Does NOT play if the clip is now full. Only really works for WeaponReloadType = RETURN_TO_BASE (e.g. airplanes); everything else loads an entire clip at once
    /// </summary>
    public AssetReference<BaseAudioEventInfo, AudioEventInfo> SingleAmmoReloadedNotFullSound;
    /// <summary>
    /// Played when the clip goes to completely full.
    /// </summary>
